...
def train(data_dir, model_dir, args):
    ...
    for epoch in range(args['epochs']):
        ...
        with torch.no_grad():
            ...
            if early > 6:
                if args['early'] == True:
                    print('no additional improvement!')
                    break
...
def cutmix_train(data_dir, model_dir, args):
    seed_everything(args['seed'])
...
def get_params():
    ...
    parser.add_argument('--model', type=str, default='MyModel1', help='model type (default: BaseModel)')
    ...
    parser.add_argument('--early',type = bool, default=False, help = 'early stopping')
...
if __name__ == '__main__':
    ...
    if params['cutmix'] == True:
        cutmix_train(data_dir,model_dir,params)
    else:
        train(data_dir, model_dir, params)