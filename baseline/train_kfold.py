...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='sj_MaskDataset', help='dataset augmentation type (default: sj_MaskDataset)')
    parser.add_argument('--augmentation', type=str, default='sj_augmentation', help='train data augmentation type (default: sj_augmentation)')
