...
if __name__ == '__main__':
    ...
    parser.add_argument('--augmentation', type=str, default='suckjin_augmentation', help='data augmentation type (default: BaseAugmentation)')
    parser.add_argument('--valid_augmentation', default='suckjin_valid_augmentation', help='model save at {SM_MODEL_DIR}/{name}')
