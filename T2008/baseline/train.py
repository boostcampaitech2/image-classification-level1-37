...
if __name__ == '__main__':
    ...
    parser.add_argument('--resize_height', type=int, default=300, help='input batch size for training (default: 64)')# b0 224 ,b1 240 ,b2 260 ,b3 300 
    parser.add_argument('--resize_width', type=int, default=250, help='input batch size for training (default: 64)') # b4 380 ,b5 456 ,b6 528 ,b7 600 
    ...
    parser.add_argument('--model_type', type=str, default='b4_timm', help='model type (range: b4_timm,b0~b7)')
